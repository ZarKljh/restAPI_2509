...
서버 밖에서도 사용 가능한 디지털 신분증

로그인 티켓 같은 것이다.

입구에서 입장권을 확인하고 팔찌를 착용하고
팔찌를 보여줌으로 놀이공원이 기구들을 이용한다

로그인을 한 후 jwt를 보여주면
이 사용자는 로그인이 완료되었음을 증명 할 수 있다

어느 특정시점에서 로그인이 풀리도록 설계한다

위조 방지 서명이 들어가기도 한다

이제는 매번 principal을 가져올 필요가 없어진다
